...
hotlog_r = "" + Math.random() + "&amp;s=592416&amp;im=69&amp;r=" +
...
try {
    ...
    if(hdiv) {
        var ihtml = '<a href="https://click.hotlog.ru/?592416" target="_blank"><img ' +
            'src="https://hit29.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
        ...
        document.write('<a href="https://click.hotlog.ru/?592416" target="_blank"><img ' +
            'src="https://hit29.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
            '" class="hotlog_counter" border="0" alt="HotLog" title="HotLog" width="88" height="31"><\/a>');
    }
}
